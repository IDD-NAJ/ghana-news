      ...
      <main className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 space-y-8">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-ghana-red mb-4">Introduction</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-ghana-red mb-4">Information We Collect</h2>
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-semibold text-ghana-green mb-2">Personal Information</h3>
                ...
                <div>
                  <h3 className="text-lg font-semibold text-ghana-green mb-2">Usage Information</h3>
                  <p className="text-gray-700">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-ghana-green mb-2">Cookies and Tracking</h3>
                  <p className="text-gray-700">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-ghana-red mb-4">How We Use Your Information</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-ghana-red mb-4">Information Sharing</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-ghana-red mb-4">Data Security</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-ghana-red mb-4">Your Rights</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-ghana-red mb-4">Contact Us</h2>
              <p className="text-gray-700 leading-relaxed">
