      ...
      <main className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 space-y-6">
            <section>
              <h2 className="text-2xl font-semibold text-ghana-red mb-4">Our Mission</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-ghana-red mb-4">Our Story</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <section>
              ...
              <div className="bg-ghana-gold bg-opacity-10 p-6 rounded-lg">
