...
const Education = () => {
  const { articles: educationNews, loading, error } = useArticles('Education');
      ...
      <div className="min-h-screen bg-gray-50 font-inter">
        ...
        <main className="container mx-auto px-4 py-8">
          <div className="text-center">
            <div className="text-lg mb-2">Loading education articles...</div>
          </div>
        </main>
        <Footer />
      </div>
            ...
            <section>
              {currentItems.length > 0 ? (
                ...
                <div className="text-center py-8">
                  <p className="text-gray-600">No education articles available at the moment.</p>
                </div>
              )}
            </section>
